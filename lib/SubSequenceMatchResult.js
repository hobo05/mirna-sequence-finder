...
class SubSequenceMatchResult {
    constructor(sourceSequence, targetSequence, subSequenceSubstringTuple, matchSubstringTupleArray) {
     ...
     */
    subSequence() {
    	return this.sourceSequence.substring(this.subSequenceSubstringTuple.start, this.subSequenceSubstringTuple.end);
    }
    ...
    percentage() {
        ...
        return totalCharsMatched / this.targetSequence.length;
    }
